const state = {
	...
	languages: [{
			...
			snippets: [{
				...
				{
					id: 4,
					name: 'synchronousFruits()',
					description: "Make multiple ajax request at the same time",
					code: "const getUser = async()=> {const a = getUserData('Gob'); const b = getUserData('Nan'); return Promise.all([a,b])} getUser().then(log)",
					isSelected: false,
					timeStamp: 1548799483448,
					tags: ['async/await'],
				},
			]
		},
